...
class DishesRepo {
  late List<Dish> dataBase = [
    ...
    const Dish(
      ...
      dishColor: AppColors.pastelBlue,
      ingredients:
    ...
    const Dish(
      ...
      dishColor: AppColors.pastelOrange,
      ingredients:
...
// class DishRepository extends StatefulWidget {
//   // Dish dish;
//   // List<Dish> newlist = [];

//   // // DishRepository : newlist = getDishes;

//   // List<Dish> get getDishes {
...
//   // void deleteDish(value) {
//   //   newlist.remove(value);
//   // }

//   const DishRepository({super.key});

//   @override
//   State<DishRepository> createState() => _DishRepositoryState();
// }

// class _DishRepositoryState extends State<DishRepository> {
//   Dish? dish;
//   List<Dish> newlist = [];
//   // DishRepository : newlist = getDishes;
//   List<Dish> get getDishes {
...
//   // _DishRepositoryState() : newlist = getDishes;
//   @override
//   Widget build(BuildContext context) {
//     return Container();
//   }

//   List<Dish> get getDishes1 => [
//         const Dish(
//           title: 'Pizza margherita',
//           purchasePlace: 'Dominos Pizza',
//           image: AppImages.pizza,
...
//   static List<Dish> get getDishes => [
//         const Dish(
//           title: 'Pizza margherita',
//           purchasePlace: 'Dominos Pizza',
//           image: AppImages.pizza,
...
//   static List<Dish> getDishes() => [
        ...
        // purchasePlace: 'Home',
        // image: AppImages.pizzaDish,
        // dishColor: AppColors.pastelGreen,
        // ingredients: ingredientsController.text,
        // instructions: instructionsController.text,
        // dishImage: AppImages.pizza,
        //),
//       ];
// }
